             ...
             <div class="row mt-4">
                 <div class="col-md-12">
                     <div class="card-columns">
                         ...
                         <%
                             List<Store> li=new StoreDaoImp().getAllStore();
                             for(Store s:li)
                             {
                            	 System.out.println("MM : "+s.getId());
                         %>
                         ...
                         <div class="card">                         
                             ...
                             <div class="card-footer text-center">
                                 ...
                                 <%
                                     if(activeUserType != null && activeUserType.equals("customer"))
                                     {
                                 %>
                                         <a href="RegisterServlet?storeId=<%=s.getId()%>"><button type="button" class="btn btn-dark">Add to Wishlist</button></a>
                                 <%
                                     }
                                 %>
                             </div>
